...
// OS provides a mock function with given fields:
func (_m *MockExecer) OS() string {
	ret := _m.Called()
...
// MockExecer_OS_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'OS'
type MockExecer_OS_Call struct {
	*mock.Call
}

// OS is a helper method to define mock.On call
func (_e *MockExecer_Expecter) OS() *MockExecer_OS_Call {
	return &MockExecer_OS_Call{Call: _e.mock.On("OS")}
}

func (_c *MockExecer_OS_Call) Run(run func()) *MockExecer_OS_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockExecer_OS_Call) Return(_a0 string) *MockExecer_OS_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockExecer_OS_Call) RunAndReturn(run func() string) *MockExecer_OS_Call {
	_c.Call.Return(run)
	return _c
}
